                ...
                <div class="col-xl-10 col-lg-12 col-md-9">
                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        <div class="card-body p-0">
                            <div class="row p-4 auto" style="background-color: #81D0C7;">
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        ...
                                        <form class="user" method="post">
                                            ...
                                            <input class="btn btn-primary btn-user btn-block mb-3" type="submit" value="Ottieni risposta" style="background-color: #246887;">
